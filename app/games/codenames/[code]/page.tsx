...
export default async function CodenamesLobbyPage({ params }: PageProps) {
  const { code } = await params;
  const view = await loadCodenamesView(code.toUpperCase());
  if (!view) notFound();
  ...
  return (
    <CodenamesLobby
      ...
      initialTeamSelect={view.teamSelect}
      initialMyRole={view.myRole}
      roster={view.roster}
