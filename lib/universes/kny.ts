...
export const kny: UniverseConfig = {
  ...
  // roster de l'anime, et aucune capture KNY n'existe encore. Les jeux gardent
  // donc temporairement celle de JJK — ajouter `/assets/<jeu>-screen-kny.png`
  ...
  // d'équivalent canonique de l'énergie occulte, l'échelle est donc celle saisie
  // en /admin (cf. lib/universes/kny-attributes.ts).
